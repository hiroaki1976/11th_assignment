...
if ($status==false) {
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    if ($_SESSION['kanri_flg'] === 1) {
      $view .= "<td>" .'<a href="delete.php?id=' . h($result['id']) . '">[削除]</a>' . "</td>";
    } else {
      $view .= "<td>" . "</td>";
    }
    $view .= "</tr>";
...
<div>
    <div>
        <h1>登録ユーザー一覧</h1>
        <table class="kanri-table">
            <tr>
                <th>登録日時</th><th>事業所名</th><th>A型</th><th>B型</th><th>移行</th><th>その他</th><th>郵便番号</th><th>都道府県</th><th>市区町村</th><th>町名など</th><th>担当者名</th><th>担当者名カナ</th><th>E-mail</th><th>管理者権限</th><th>削除ボタン</th>
            </tr>
